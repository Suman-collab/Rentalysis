        ...
        <div className="flex-1 space-y-6">
          <div className="bg-white border border-neutral-200 rounded-xl overflow-hidden shadow-sm">
            <div className="p-4 border-b border-neutral-100 bg-neutral-50 flex justify-between items-center">
              <h3 className="font-semibold text-neutral-900">Selected Items ({cartItems.length})</h3>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center justify-between mt-4">
                      <div className="flex items-center border border-neutral-200 rounded-lg">
                        <button className="px-3 py-1 hover:bg-neutral-50 text-neutral-600">-</button>
                        <span className="px-2 font-medium text-sm w-8 text-center">{item.quantity}</span>
                        <button className="px-3 py-1 hover:bg-neutral-50 text-neutral-600">+</button>
                      </div>

                      <button className="text-neutral-400 hover:text-red-500 p-2 transition-colors">
          ...
          <div className="bg-white border border-neutral-200 rounded-xl p-6 shadow-sm flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-neutral-500">Oct 17 - Oct 19, 2023</p>
              </div>
            </div>
            <button className="text-sm font-semibold text-blue-600 border border-blue-200 px-4 py-2 rounded-lg hover:bg-blue-50">
              Change Dates
            </button>
          </div>
        </div>
